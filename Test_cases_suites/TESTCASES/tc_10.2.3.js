 ...
 */
casper.test.begin("Edit Rmarkdown Cell (pre-executed)", 6, function suite(test) {
    ...
    casper.viewport(1366, 768).then(function () {
        ...
        this.test.assertEquals(temp, initialcontent, "Confirmed that the edited cell content in the markdown cell has been saved by Autosave feature");
    });
