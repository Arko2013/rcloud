...
casper.test.begin("Github Username as Search Text", 4, function suite(test) {
    ...
    casper.viewport(1024, 768).then(function () {
        ...
        casper.viewport(1366, 768).then(function () {
            ...
            var flag = 0;//to check if the notebook belonging to the user has been found
            ...
            this.test.assertEquals(flag, 1, "Verified that Notebook belonging to Searched user has been found");
        });//function closes
    });
