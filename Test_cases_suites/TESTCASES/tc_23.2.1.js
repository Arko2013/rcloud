...
casper.test.begin(" Number of Results Found should match Number of Results Displayed ", 5, function suite(test) {
    ...
    casper.viewport(1024, 768).then(function () {
        ...
        this.wait(5000);
        this.test.assertElementCount(x('/html/body/div[3]/div/div/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/table/tbody/tr/td/a'), counter, '  Number of Results Found is equal to the Number of Results Displayed ');
    });
