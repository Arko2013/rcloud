/*
 ...
 Author: Arko
 Description:This is a casperjs automation script to show that the checkbox for "show source" is selected for showing the source code when a notebook is executed
 */
casper.test.begin("Show source Checkbox selected", 5, function suite(test) {
    ...
    casper.viewport(1366, 768).then(function () {
        this.test.assertVisible({type: 'css', path: "#show-source .icon-check"}, "Show Source checkbox is selected");
