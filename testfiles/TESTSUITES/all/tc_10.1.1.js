 ...
 */
casper.test.begin("Write some code in the Prompt Cell", 5, function suite(test) {
    ...
    casper.viewport(1366, 768).then(function () {
        ...
        var content = this.fetchText('.ace_line');
        this.echo("Content present in prompt cell after reload = " + content);
        this.test.assertEquals(content, source_code, "Confirmed that the content remains in the prompt cell after reload")
    });
