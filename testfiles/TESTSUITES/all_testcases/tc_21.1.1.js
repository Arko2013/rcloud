...
casper.test.begin(" Edit a cell from a notebook", 6, function suite(test) {
    ...
    var item1 = 'asia';//1st item to be searched
    var item2 = 'continent';//item to be searched
    ...
    casper.viewport(1024, 768).then(function () {
        ...
        functions.search(casper, temp, combo);
    });
