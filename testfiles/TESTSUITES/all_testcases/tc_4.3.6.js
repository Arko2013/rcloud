 ...
 */
casper.test.begin("Pre executed two or more R cells and Rmarkdown cells to be executed using Run All", 8, function suite(test) {
    ...
    casper.viewport(1366, 768).then(function () {
        ...
        this.wait(5000);
        this.echo("executed contents of a markdown cell");
