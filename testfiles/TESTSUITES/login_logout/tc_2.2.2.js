/* 
 ...
 the link "Log Back In", the page gets re-directed to the Github page asking for credentials and then, "main.html" page is loaded 
 */

//Begin Tests

casper.test.begin("Logout of Github", 4, function suite(test) {
