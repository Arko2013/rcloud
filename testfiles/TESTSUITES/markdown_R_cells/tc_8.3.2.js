 ...
 */
casper.test.begin("Insert a Rmarkdown cell on top of an existing Rmarkdown cell", 5, function suite(test) {
    ...
    casper.then(function () {
        ...
        this.wait(5000);
        this.test.assertElementCount({type: 'css', path: 'div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > textarea:nth-child(1)'}, 2, "New Markdown cell created over the existing one");
    });
