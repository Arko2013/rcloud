 ...
 */
casper.test.begin("Delete R cell and switch notebook", 6, function suite(test) {
    ...
    //load the previous notebook and check if R cell is still deleted
    casper.then(function () {
        ...
        if (flag == 1) {
            ...
            this.wait(7000);
            this.test.assertDoesntExist({type: 'css', path: '.r-result-div'}, "Confirmed that R cell remained deleted after switching back to Notebook " + title);
        }
        else {
