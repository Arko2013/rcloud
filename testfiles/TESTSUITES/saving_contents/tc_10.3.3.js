 ...
 */
casper.test.begin("Edit Rmarkdown Cell (one Rmarkdown cell pre-executed)", 5, function suite(test) {
    ...
    casper.then(function () {
        this.echo("Now we have a markdown cell with a preexecuted cell,which is the pre-requisite for this test case.Now to modify the contents");
        functions.addcontentstocell(casper);
    });
