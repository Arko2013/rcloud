 ...
 */
casper.test.begin("Using save icon present in the navbar - Edit R Cell (pre-executed)", 6, function suite(test) {
    ...
    casper.viewport(1366, 768).then(function () {
        ...
        this.click({type: 'xpath', path: "/html/body/div[3]/div/div[2]/div/div/div/div/div/table/td/span/i"});
        this.wait(5000);
    });

    casper.viewport(1366, 768).then(function () {
        //checking whether contents are written on Rcell or not
        var temp = this.fetchText({type: 'xpath', path: '/html/body/div[3]/div/div[2]/div/div/div[2]/div[3]/div/div/div[2]/div/div[3]/div/div'});
