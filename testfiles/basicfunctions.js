...
//Add contents to the FIRST cell and then execute it using run option
exports.addcontentstocell = function(casper){
	return casper 
	.then(function(){
		this.sendKeys('div.ace-chrome:nth-child(1) > textarea:nth-child(1)','rnorm(3)');
...
exports.open_advanceddiv = function(casper){
	return casper 
	.then(function(){
		this.click({type: 'xpath', path: '/html/body/div[2]/div/div[2]/ul[2]/li/a/b'},'Advanced div opened');
        this.wait(6000);
    });
};
...
exports.peopleIstarred = function(casper){
	...
	.then(function(){
		...
		if(flag == 1)
		{
			this.echo("Notebook with title "+ title + " is PRESENT under People I Starred list with star count = "+starcount);
		}
		else
		{
			this.echo("Notebook with title "+ title + " is ABSENT under People I Starred list");
		}
	});
};
...
exports.allnotebooks = function(casper){
	...
	.then(function(){
		...
		if(flag == 1)
		{
			this.echo("Notebook with title "+ title + " is PRESENT under All Notebooks list with star count = "+starcount);
		}
		else
		{
			this.echo("Notebook with title "+ title + " is ABSENT under My Notebooks for All Notebooks list");
		}
	});
};
